...
const Form=({todos,setTodos,inputText,setInputText,setStatus})=>{
    ...
    return(
        ...
        <div class="relative inline-flex ml-5">
            ...
            <select onChange={statusHandler} name="todos" class="border border-gray-300 rounded-lg text-gray-600 h-14 pl-5 pr-10 bg-gray-100 shadow-inner hover:border-gray-400 focus:outline-none appearance-none">
